...
dataf<-read.table(paste("input/finaldatainput.scrambled"), header=TRUE)
...
write.table(varimp, "output/party.varVIM.scrambled.importance", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(varimpAUC, "output/party.varVIMAUC.scrambled.importance", row.names=FALSE, col.names=TRUE,quote=FALSE)
