...
mindep_dataf<-read.table(paste("input/finaldatainput.scrambled"), header=TRUE)
...
write.table(min_depth19, "output/RFSC.mindepth_RF19.scrambled.mindep", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(vim19, "output/RFSC.VIM_RF19.scrambled.importance", row.names=FALSE, col.names=TRUE,quote=FALSE)
