...
af<-read.table(paste("nullDATA40_5intweakfull033.",i,sep=""),header=TRUE)
#[,1]
ar<-read.table(paste("nullDATA40_5intweakred05.",i,sep=""),header=TRUE)
#[,1]
...
write.table(depth15f,"nullmindepth40_5_39weakfull033",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp15f,"nullvimp40_5_39weakfull033",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3f,"nullmindepth40_5_27weakfull033",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp3f,"nullvimp40_5_27weakfull033",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth15r,"nullmindepth40_5_39weakred05",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp15r,"nullvimp40_5_39weakred05",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3r,"nullmindepth40_5_27weakred05",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp3r,"nullvimp40_5_27weakred05",row.names=FALSE,col.names=TRUE,quote=FALSE)
