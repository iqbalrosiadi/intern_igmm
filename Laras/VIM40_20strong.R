...
dataf<-read.table(paste("DATA40_20intstrongfullnew.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA40_20intstrongrednew.",i, sep=""), header=TRUE)
...
write.table(VIM40_20f, "VIM40_20intstrongfullnew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC40_20f, "VIMAUC40_20intstrongfullnew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIM40_20r, "VIM40_20intstrongrednew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC40_20r, "VIMAUC40_20intstrongrednew", row.names=FALSE, col.names=TRUE,quote=FALSE)
