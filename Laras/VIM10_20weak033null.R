...
dataf<-read.table(paste("nullDATA10_20intweakfull033.",i, sep=""), header=TRUE)
datar<-read.table(paste("nullDATA10_20intweakred05.",i, sep=""), header=TRUE)
...
write.table(nullVIM10_20f, "nullVIM10_20intweakfull033", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC10_20f, "nullVIMAUC10_20intweakfull033", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIM10_20r, "nullVIM10_20intweakred05", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC10_20r, "nullVIMAUC10_20intweakred05", row.names=FALSE, col.names=TRUE,quote=FALSE)
