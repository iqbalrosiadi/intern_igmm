...
dataf<-read.table(paste("DATA40_5intweakfullnew.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA40_5intweakrednew.",i, sep=""), header=TRUE)
...
write.table(VIM40_5f, "VIM40_5intweakfullnew", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC40_5f, "VIMAUC40_5intweakfullnew", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIM40_5r, "VIM40_5intweakrednew", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC40_5r, "VIMAUC40_5intweakrednew", row.names=FALSE, col.names=FALSE,quote=FALSE)
