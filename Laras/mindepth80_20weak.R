...
af<-read.table(paste("DATA80_20intweakfullnew.",i,sep=""),header=TRUE)
yf<-af[,1]
ar<-read.table(paste("DATA80_20intweakrednew.",i,sep=""),header=TRUE)
yr<-ar[,1]
...
write.table(depth15f,"mindepth80_20_1700weakfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp15f,"vimp80_20_1700weakfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3f,"mindepth80_20_1600weakfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp3f,"vimp80_20_1600weakfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth15r,"mindepth80_20_39weakrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp15r,"vimp80_20_39weakrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3r,"mindepth80_20_27weakrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp3r,"vimp80_20_27weakrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
