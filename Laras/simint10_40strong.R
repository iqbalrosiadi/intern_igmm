...
write.table(data2, paste("DATA10_40intstrongfullnew.",i, sep=""), row.names=FALSE, quote=FALSE)
write.table(data3, paste("DATA10_40intstrongrednew.",i, sep=""), row.names=FALSE, quote=FALSE)
}
