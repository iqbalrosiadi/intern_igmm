...
dataf<-read.table(paste("nullDATA40_40intweakfullmid.",i, sep=""), header=TRUE)
datar<-read.table(paste("nullDATA40_40intweakredmid.",i, sep=""), header=TRUE)
...
write.table(nullVIM40_40f, "nullVIM40_40intweakfullmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC40_40f, "nullVIMAUC40_40intweakfullmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIM40_40r, "nullVIM40_40intweakredmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC40_40r, "nullVIMAUC40_40intweakredmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
