...
dataf<-read.table(paste("nullDATA10_40intweakfullmid.",i, sep=""), header=TRUE)
datar<-read.table(paste("nullDATA10_40intweakredmid.",i, sep=""), header=TRUE)
...
write.table(nullVIM10_40f, "nullVIM10_40intweakfullmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC10_40f, "nullVIMAUC10_40intweakfullmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIM10_40r, "nullVIM10_40intweakredmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC10_40r, "nullVIMAUC10_40intweakredmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
