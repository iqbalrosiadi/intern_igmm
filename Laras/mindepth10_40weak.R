...
af<-read.table(paste("DATA10_40intweakfullnew.",i,sep=""),header=TRUE)
yf<-af[,1]
ar<-read.table(paste("DATA10_40intweakrednew.",i,sep=""),header=TRUE)
yr<-ar[,1]
...
write.table(depth15f,"mindepth10_40_1700weakfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp15f,"vimp10_40_1700weakfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3f,"mindepth10_40_1600weakfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp3f,"vimp10_40_1600weakfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth15r,"mindepth10_40_39weakrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp15r,"vimp10_40_39weakrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3r,"mindepth10_40_27weakrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp3r,"vimp10_40_27weakrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
