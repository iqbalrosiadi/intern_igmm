...
dataf<-read.table(paste("nullDATA40_20intweakfullmid.",i, sep=""), header=TRUE)
datar<-read.table(paste("nullDATA40_20intweakredmid.",i, sep=""), header=TRUE)
...
write.table(nullVIM40_20f, "nullVIM40_20intweakfullmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC40_20f, "nullVIMAUC40_20intweakfullmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIM40_20r, "nullVIM40_20intweakredmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC40_20r, "nullVIMAUC40_20intweakredmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
