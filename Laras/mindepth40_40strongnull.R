...
af<-read.table(paste("nullDATA40_40intstrongfullnew.",i,sep=""),header=TRUE)
yf<-af[,1]
ar<-read.table(paste("nullDATA40_40intstrongrednew.",i,sep=""),header=TRUE)
yr<-ar[,1]
...
write.table(depth15f,"nullmindepth40_40_39strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp15f,"nullvimp40_40_39strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3f,"nullmindepth40_40_27strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp3f,"nullvimp40_40_27strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth15r,"nullmindepth40_40_39strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp15r,"nullvimp40_40_39strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3r,"nullmindepth40_40_27strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp3r,"nullvimp40_40_27strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
