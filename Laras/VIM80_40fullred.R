...
dataf<-read.table(paste("DATA80_40intweakfullnew.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA80_40intweakrednew.",i, sep=""), header=TRUE)
...
write.table(VIM80_40f, "VIM80_40intweakfullnew", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC80_40f, "VIMAUC80_40intweakfullnew", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIM80_40r, "VIM80_40intweakrednew", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC80_40r, "VIMAUC80_40intweakrednew", row.names=FALSE, col.names=FALSE,quote=FALSE)
