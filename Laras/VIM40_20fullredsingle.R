...
dataf<-read.table(paste("DATA40_20intweakfullsingle.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA40_20intweakredsingle.",i, sep=""), header=TRUE)
...
write.table(VIM40_20f, "VIM40_20intweakfullsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC40_20f, "VIMAUC40_20intweakfullsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIM40_20r, "VIM40_20intweakredsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC40_20r, "VIMAUC40_20intweakredsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
