...
af<-read.table(paste("nullDATA80_5intstrongfullnew.",i,sep=""),header=TRUE)
yf<-af[,1]
ar<-read.table(paste("nullDATA80_5intstrongrednew.",i,sep=""),header=TRUE)
yr<-ar[,1]
...
write.table(depth15f,"nullmindepth80_5_39strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp15f,"nullvimp80_5_39strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3f,"nullmindepth80_5_27strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp3f,"nullvimp80_5_27strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth15r,"nullmindepth80_5_39strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp15r,"nullvimp80_5_39strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3r,"nullmindepth80_5_27strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp3r,"nullvimp80_5_27strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
