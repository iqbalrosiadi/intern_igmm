...
dataf<-read.table(paste("DATA10_40intweakfullsingle.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA10_40intweakredsingle.",i, sep=""), header=TRUE)
...
write.table(VIM10_40f, "VIM10_40intweakfullsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC10_40f, "VIMAUC10_40intweakfullsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIM10_40r, "VIM10_40intweakredsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC10_40r, "VIMAUC10_40intweakredsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
