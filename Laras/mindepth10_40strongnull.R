...
af<-read.table(paste("nullDATA10_40intstrongfullnew.",i,sep=""),header=TRUE)
yf<-af[,1]
ar<-read.table(paste("nullDATA10_40intstrongrednew.",i,sep=""),header=TRUE)
yr<-ar[,1]
...
write.table(depth15f,"nullmindepth10_40_39strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp15f,"nullvimp10_40_39strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3f,"nullmindepth10_40_27strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp3f,"nullvimp10_40_27strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth15r,"nullmindepth10_40_39strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp15r,"nullvimp10_40_39strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3r,"nullmindepth10_40_27strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp3r,"nullvimp10_40_27strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
