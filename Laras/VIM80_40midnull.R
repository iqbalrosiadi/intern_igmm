...
dataf<-read.table(paste("nullDATA80_40intweakfullmid.",i, sep=""), header=TRUE)
datar<-read.table(paste("nullDATA80_40intweakredmid.",i, sep=""), header=TRUE)
...
write.table(nullVIM80_40f, "nullVIM80_40intweakfullmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC80_40f, "nullVIMAUC80_40intweakfullmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIM80_40r, "nullVIM80_40intweakredmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC80_40r, "nullVIMAUC80_40intweakredmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
