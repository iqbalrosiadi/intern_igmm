...
dataf<-read.table(paste("nullDATA10_5intweakfull033.",i, sep=""), header=TRUE)
datar<-read.table(paste("nullDATA10_5intweakred05.",i, sep=""), header=TRUE)
...
write.table(nullVIM10_5f, "nullVIM10_5intweakfull033", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC10_5f, "nullVIMAUC10_5intweakfull033", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIM10_5r, "nullVIM10_5intweakred05", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC10_5r, "nullVIMAUC10_5intweakred05", row.names=FALSE, col.names=TRUE,quote=FALSE)
