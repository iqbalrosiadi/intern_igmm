...
dataf<-read.table(paste("DATA10_20intweakfull033.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA10_20intweakred05.",i, sep=""), header=TRUE)
...
write.table(VIM10_20f, "VIM10_20intweakfull033", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC10_20f, "VIMAUC10_20intweakfull033", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIM10_20r, "VIM10_20intweakred05", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC10_20r, "VIMAUC10_20intweakred05", row.names=FALSE, col.names=TRUE,quote=FALSE)
