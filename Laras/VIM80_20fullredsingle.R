...
dataf<-read.table(paste("DATA80_20intweakfullsingle.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA80_20intweakredsingle.",i, sep=""), header=TRUE)
...
write.table(VIM80_20f, "VIM80_20intweakfullsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC80_20f, "VIMAUC80_20intweakfullsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIM80_20r, "VIM80_20intweakredsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC80_20r, "VIMAUC80_20intweakredsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
