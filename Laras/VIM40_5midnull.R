...
dataf<-read.table(paste("nullDATA40_5intweakfullmid.",i, sep=""), header=TRUE)
datar<-read.table(paste("nullDATA40_5intweakredmid.",i, sep=""), header=TRUE)
...
write.table(nullVIM40_5f, "nullVIM40_5intweakfullmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC40_5f, "nullVIMAUC40_5intweakfullmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIM40_5r, "nullVIM40_5intweakredmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC40_5r, "nullVIMAUC40_5intweakredmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
