...
dataf<-read.table(paste("nullDATA10_40intstrongfullnew.",i, sep=""), header=TRUE)
datar<-read.table(paste("nullDATA10_40intstrongrednew.",i, sep=""), header=TRUE)
...
write.table(nullVIM10_40f, "nullVIM10_40intstrongfullnew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC10_40f, "nullVIMAUC10_40intstrongfullnew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIM10_40r, "nullVIM10_40intstrongrednew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC10_40r, "nullVIMAUC10_40intstrongrednew", row.names=FALSE, col.names=TRUE,quote=FALSE)
