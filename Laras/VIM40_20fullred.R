...
dataf<-read.table(paste("DATA40_20intweakfullnew.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA40_20intweakrednew.",i, sep=""), header=TRUE)
...
write.table(VIM40_20f, "VIM40_20intweakfullnew", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC40_20f, "VIMAUC40_20intweakfullnew", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIM40_20r, "VIM40_20intweakrednew", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC40_20r, "VIMAUC40_20intweakrednew", row.names=FALSE, col.names=FALSE,quote=FALSE)
