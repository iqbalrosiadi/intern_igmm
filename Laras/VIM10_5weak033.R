...
dataf<-read.table(paste("DATA10_5intweakfull033.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA10_5intweakred05.",i, sep=""), header=TRUE)
...
write.table(VIM10_5f, "VIM10_5intweakfull033", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC10_5f, "VIMAUC10_5intweakfull033", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIM10_5r, "VIM10_5intweakred05", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC10_5r, "VIMAUC10_5intweakred05", row.names=FALSE, col.names=TRUE,quote=FALSE)
