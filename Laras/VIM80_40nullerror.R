...
dataf<-read.table(paste("DATA80_40nullerror005.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA80_40nullerror05.",i, sep=""), header=TRUE)
...
write.table(VIM80_40f, "VIM80_40nullerror005", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC80_40f, "VIMAUC80_40nullerror005", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIM80_40r, "VIM80_40nullerror05", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC80_40r, "VIMAUC80_40nullerror05", row.names=FALSE, col.names=TRUE,quote=FALSE)
