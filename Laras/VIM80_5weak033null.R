...
dataf<-read.table(paste("nullDATA80_5intweakfull033.",i, sep=""), header=TRUE)
datar<-read.table(paste("nullDATA80_5intweakred05.",i, sep=""), header=TRUE)
...
write.table(nullVIM80_5f, "nullVIM80_5intweakfull033", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC80_5f, "nullVIMAUC80_5intweakfull033", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIM80_5r, "nullVIM80_5intweakred05", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC80_5r, "nullVIMAUC80_5intweakred05", row.names=FALSE, col.names=TRUE,quote=FALSE)
