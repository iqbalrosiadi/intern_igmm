...
af<-read.table(paste("DATA10_5intweakfullmid.",i,sep=""),header=TRUE)
#[,1]
ar<-read.table(paste("DATA10_5intweakredmid.",i,sep=""),header=TRUE)
#[,1]
...
write.table(depth15f,"mindepth10_5_39weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp15f,"vimp10_5_39weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3f,"mindepth10_5_27weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp3f,"vimp10_5_27weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth15r,"mindepth10_5_39weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp15r,"vimp10_5_39weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3r,"mindepth10_5_27weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp3r,"vimp10_5_27weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
