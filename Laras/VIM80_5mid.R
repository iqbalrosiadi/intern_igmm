...
dataf<-read.table(paste("DATA80_5intweakfullmid.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA80_5intweakredmid.",i, sep=""), header=TRUE)
...
write.table(VIM80_5f, "VIM80_5intweakfullmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC80_5f, "VIMAUC80_5intweakfullmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIM80_5r, "VIM80_5intweakredmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC80_5r, "VIMAUC80_5intweakredmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
