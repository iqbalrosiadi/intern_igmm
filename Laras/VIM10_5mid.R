...
dataf<-read.table(paste("DATA10_5intweakfullmid.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA10_5intweakredmid.",i, sep=""), header=TRUE)
...
write.table(VIM10_5f, "VIM10_5intweakfullmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC10_5f, "VIMAUC10_5intweakfullmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIM10_5r, "VIM10_5intweakredmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC10_5r, "VIMAUC10_5intweakredmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
