...
dataf<-read.table(paste("DATA40_5intstrongfullnew.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA40_5intstrongrednew.",i, sep=""), header=TRUE)
...
write.table(VIM40_5f, "VIM40_5intstrongfullnew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC40_5f, "VIMAUC40_5intstrongfullnew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIM40_5r, "VIM40_5intstrongrednew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC40_5r, "VIMAUC40_5intstrongrednew", row.names=FALSE, col.names=TRUE,quote=FALSE)
