...
af<-read.table(paste("data/DATA10_20intstrongfullnew.",i,sep=""),header=TRUE)
#[,1]
ar<-read.table(paste("data/DATA10_20intstrongrednew.",i,sep=""),header=TRUE)
#[,1]
...
write.table(depth15f,"output/mindepth10_20_39strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp15f,"output/vimp10_20_39strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3f,"output/mindepth10_20_27strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp3f,"output/vimp10_20_27strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth15r,"output/mindepth10_20_39strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp15r,"output/vimp10_20_39strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3r,"output/mindepth10_20_27strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp3r,"output/vimp10_20_27strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
