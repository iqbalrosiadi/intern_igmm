...
corr1<-matrix(0,nrow=20,ncol=20)
for(i in 1:20){
        for(j in 1:20){
                if(i==j){
                        corr1[i,j]=1
...
ceros1<-matrix(0,nrow=80,ncol=20)
corr1<-rbind(corr1,ceros1)
ceros2<-matrix(0,nrow=20,ncol=80)
corr2<-diag(80)
...
write.table(data2, paste("data/DATA10_20intstrongfullnew.",i, sep=""), row.names=FALSE, quote=FALSE)
write.table(data3, paste("data/DATA10_20intstrongrednew.",i, sep=""), row.names=FALSE, quote=FALSE)
}
