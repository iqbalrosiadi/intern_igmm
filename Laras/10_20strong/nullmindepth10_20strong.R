...
af<-read.table(paste("nullDATA10_20intstrongfullnew.",i,sep=""),header=TRUE)
#[,1]
ar<-read.table(paste("nullDATA10_20intstrongrednew.",i,sep=""),header=TRUE)
#[,1]
...
write.table(depth15f,"nullmindepth10_20_39strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp15f,"nullvimp10_20_39strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3f,"nullmindepth10_20_27strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp3f,"nullvimp10_20_27strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth15r,"nullmindepth10_20_39strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp15r,"nullvimp10_20_39strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3r,"nullmindepth10_20_27strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp3r,"nullvimp10_20_27strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
