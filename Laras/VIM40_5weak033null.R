...
dataf<-read.table(paste("nullDATA40_5intweakfull033.",i, sep=""), header=TRUE)
datar<-read.table(paste("nullDATA40_5intweakred05.",i, sep=""), header=TRUE)
...
write.table(nullVIM40_5f, "nullVIM40_5intweakfull033", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC40_5f, "nullVIMAUC40_5intweakfull033", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIM40_5r, "nullVIM40_5intweakred05", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC40_5r, "nullVIMAUC40_5intweakred05", row.names=FALSE, col.names=TRUE,quote=FALSE)
