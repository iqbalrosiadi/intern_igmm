...
dataf<-read.table(paste("DATA80_5intstrongfullnew.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA80_5intstrongrednew.",i, sep=""), header=TRUE)
...
write.table(VIM80_5f, "VIM80_5intstrongfullnew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC80_5f, "VIMAUC80_5intstrongfullnew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIM80_5r, "VIM80_5intstrongrednew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC80_5r, "VIMAUC80_5intstrongrednew", row.names=FALSE, col.names=TRUE,quote=FALSE)
