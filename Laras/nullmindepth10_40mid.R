...
af<-read.table(paste("nullDATA10_40intweakfullmid.",i,sep=""),header=TRUE)
#[,1]
ar<-read.table(paste("nullDATA10_40intweakredmid.",i,sep=""),header=TRUE)
#[,1]
...
write.table(depth15f,"nullmindepth10_40_39weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp15f,"nullvimp10_40_39weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3f,"nullmindepth10_40_27weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp3f,"nullvimp10_40_27weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth15r,"nullmindepth10_40_39weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp15r,"nullvimp10_40_39weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3r,"nullmindepth10_40_27weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp3r,"nullvimp10_40_27weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
