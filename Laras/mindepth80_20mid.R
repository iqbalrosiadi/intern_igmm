...
af<-read.table(paste("DATA80_20intweakfullmid.",i,sep=""),header=TRUE)
#[,1]
ar<-read.table(paste("DATA80_20intweakredmid.",i,sep=""),header=TRUE)
#[,1]
...
write.table(depth15f,"mindepth80_20_39weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp15f,"vimp80_20_39weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3f,"mindepth80_20_27weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp3f,"vimp80_20_27weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth15r,"mindepth80_20_39weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp15r,"vimp80_20_39weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3r,"mindepth80_20_27weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp3r,"vimp80_20_27weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
