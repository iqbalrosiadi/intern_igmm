...
af<-read.table(paste("DATA80_40intweakfullmid.",i,sep=""),header=TRUE)
#[,1]
ar<-read.table(paste("DATA80_40intweakredmid.",i,sep=""),header=TRUE)
#[,1]
...
write.table(depth15f,"mindepth80_40_39weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp15f,"vimp80_40_39weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3f,"mindepth80_40_27weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp3f,"vimp80_40_27weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth15r,"mindepth80_40_39weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp15r,"vimp80_40_39weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3r,"mindepth80_40_27weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp3r,"vimp80_40_27weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
