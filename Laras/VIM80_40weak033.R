...
dataf<-read.table(paste("DATA80_40intweakfull033.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA80_40intweakred05.",i, sep=""), header=TRUE)
...
write.table(VIM80_40f, "VIM80_40intweakfull033", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC80_40f, "VIMAUC80_40intweakfull033", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIM80_40r, "VIM80_40intweakred05", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC80_40r, "VIMAUC80_40intweakred05", row.names=FALSE, col.names=TRUE,quote=FALSE)
