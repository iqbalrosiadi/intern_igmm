...
dataf<-read.table(paste("nullDATA80_20intweakfullmid.",i, sep=""), header=TRUE)
datar<-read.table(paste("nullDATA80_20intweakredmid.",i, sep=""), header=TRUE)
...
write.table(nullVIM80_20f, "nullVIM80_20intweakfullmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC80_20f, "nullVIMAUC80_20intweakfullmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIM80_20r, "nullVIM80_20intweakredmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC80_20r, "nullVIMAUC80_20intweakredmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
