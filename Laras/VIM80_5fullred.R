...
dataf<-read.table(paste("DATA80_5intweakfullnew.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA80_5intweakrednew.",i, sep=""), header=TRUE)
...
write.table(VIM80_5f, "VIM80_5intweakfullnew", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC80_5f, "VIMAUC80_5intweakfullnew", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIM80_5r, "VIM80_5intweakrednew", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC80_5r, "VIMAUC80_5intweakrednew", row.names=FALSE, col.names=FALSE,quote=FALSE)
