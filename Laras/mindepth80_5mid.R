...
af<-read.table(paste("DATA80_5intweakfullmid.",i,sep=""),header=TRUE)
#[,1]
ar<-read.table(paste("DATA80_5intweakredmid.",i,sep=""),header=TRUE)
#[,1]
...
write.table(depth15f,"mindepth80_5_39weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp15f,"vimp80_5_39weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3f,"mindepth80_5_27weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp3f,"vimp80_5_27weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth15r,"mindepth80_5_39weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp15r,"vimp80_5_39weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3r,"mindepth80_5_27weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp3r,"vimp80_5_27weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
