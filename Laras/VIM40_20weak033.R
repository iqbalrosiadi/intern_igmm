...
dataf<-read.table(paste("DATA40_20intweakfull033.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA40_20intweakred05.",i, sep=""), header=TRUE)
...
write.table(VIM40_20f, "VIM40_20intweakfull033", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC40_20f, "VIMAUC40_20intweakfull033", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIM40_20r, "VIM40_20intweakred05", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC40_20r, "VIMAUC40_20intweakred05", row.names=FALSE, col.names=TRUE,quote=FALSE)
