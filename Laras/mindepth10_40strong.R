...
af<-read.table(paste("DATA10_40intstrongfullnew.",i,sep=""),header=TRUE)
#[,1]
ar<-read.table(paste("DATA10_40intstrongrednew.",i,sep=""),header=TRUE)
#[,1]
...
write.table(depth15f,"mindepth10_40_39strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp15f,"vimp10_40_39strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3f,"mindepth10_40_27strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp3f,"vimp10_40_27strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth15r,"mindepth10_40_39strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp15r,"vimp10_40_39strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3r,"mindepth10_40_27strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp3r,"vimp10_40_27strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
