...
dataf<-read.table(paste("DATA10_5intweakfullsingle.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA10_5intweakredsingle.",i, sep=""), header=TRUE)
...
write.table(VIM10_5f, "VIM10_5intweakfullsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC10_5f, "VIMAUC10_5intweakfullsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIM10_5r, "VIM10_5intweakredsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC10_5r, "VIMAUC10_5intweakredsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
