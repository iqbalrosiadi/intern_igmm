...
dataf<-read.table(paste("DATA10_40intweakfullnew.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA10_40intweakrednew.",i, sep=""), header=TRUE)
...
write.table(VIM10_40f, "VIM10_40intweakfullnew", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC10_40f, "VIMAUC10_40intweakfullnew", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIM10_40r, "VIM10_40intweakrednew", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC10_40r, "VIMAUC10_40intweakrednew", row.names=FALSE, col.names=FALSE,quote=FALSE)
