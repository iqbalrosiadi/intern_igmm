...
dataf<-read.table(paste("DATA80_40intweakfullsingle.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA80_40intweakredsingle.",i, sep=""), header=TRUE)
...
write.table(VIM80_40f, "VIM80_40intweakfullsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC80_40f, "VIMAUC80_40intweakfullsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIM80_40r, "VIM80_40intweakredsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC80_40r, "VIMAUC80_40intweakredsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
