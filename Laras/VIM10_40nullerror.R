...
dataf<-read.table(paste("DATA10_40nullerror005.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA10_40nullerror05.",i, sep=""), header=TRUE)
...
write.table(VIM10_40f, "VIM10_40nullerror005", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC10_40f, "VIMAUC10_40nullerror005", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIM10_40r, "VIM10_40nullerror05", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC10_40r, "VIMAUC10_40nullerror05", row.names=FALSE, col.names=TRUE,quote=FALSE)
