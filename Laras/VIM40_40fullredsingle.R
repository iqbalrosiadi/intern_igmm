...
dataf<-read.table(paste("DATA40_40intweakfullsingle.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA40_40intweakredsingle.",i, sep=""), header=TRUE)
...
write.table(VIM40_40f, "VIM40_40intweakfullsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC40_40f, "VIMAUC40_40intweakfullsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIM40_40r, "VIM40_40intweakredsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC40_40r, "VIMAUC40_40intweakredsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
