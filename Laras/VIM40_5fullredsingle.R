...
dataf<-read.table(paste("DATA40_5intweakfullsingle.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA40_5intweakredsingle.",i, sep=""), header=TRUE)
...
write.table(VIM40_5f, "VIM40_5intweakfullsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC40_5f, "VIMAUC40_5intweakfullsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIM40_5r, "VIM40_5intweakredsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
write.table(VIMAUC40_5r, "VIMAUC40_5intweakredsingle", row.names=FALSE, col.names=FALSE,quote=FALSE)
