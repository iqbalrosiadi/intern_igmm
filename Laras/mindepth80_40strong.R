...
af<-read.table(paste("DATA80_40intstrongfullnew.",i,sep=""),header=TRUE)
#[,1]
ar<-read.table(paste("DATA80_40intstrongrednew.",i,sep=""),header=TRUE)
#[,1]
...
write.table(depth15f,"mindepth80_40_39strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp15f,"vimp80_40_39strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3f,"mindepth80_40_27strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp3f,"vimp80_40_27strongfullnew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth15r,"mindepth80_40_39strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp15r,"vimp80_40_39strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3r,"mindepth80_40_27strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp3r,"vimp80_40_27strongrednew",row.names=FALSE,col.names=TRUE,quote=FALSE)
