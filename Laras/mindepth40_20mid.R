...
af<-read.table(paste("DATA40_20intweakfullmid.",i,sep=""),header=TRUE)
#[,1]
ar<-read.table(paste("DATA40_20intweakredmid.",i,sep=""),header=TRUE)
#[,1]
...
write.table(depth15f,"mindepth40_20_39weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp15f,"vimp40_20_39weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3f,"mindepth40_20_27weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp3f,"vimp40_20_27weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth15r,"mindepth40_20_39weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp15r,"vimp40_20_39weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3r,"mindepth40_20_27weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(vimp3r,"vimp40_20_27weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
