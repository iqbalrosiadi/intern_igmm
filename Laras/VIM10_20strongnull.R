...
dataf<-read.table(paste("nullDATA10_20intstrongfullnew.",i, sep=""), header=TRUE)
datar<-read.table(paste("nullDATA10_20intstrongrednew.",i, sep=""), header=TRUE)
...
write.table(nullVIM10_20f, "nullVIM10_20intstrongfullnew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC10_20f, "nullVIMAUC10_20intstrongfullnew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIM10_20r, "nullVIM10_20intstrongrednew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC10_20r, "nullVIMAUC10_20intstrongrednew", row.names=FALSE, col.names=TRUE,quote=FALSE)
