...
corr1<-matrix(0,nrow=40,ncol=40)
for(i in 1:40){
        for(j in 1:40){
                if(i==j){
                        corr1[i,j]=1
...
ceros1<-matrix(0,nrow=60,ncol=40)
corr1<-rbind(corr1,ceros1)
ceros2<-matrix(0,nrow=40,ncol=60)
corr2<-diag(60)
...
write.table(data2, paste("DATA80_40intstrongfullnew.",i, sep=""), row.names=FALSE, quote=FALSE)
write.table(data3, paste("DATA80_40intstrongrednew.",i, sep=""), row.names=FALSE, quote=FALSE)
}
