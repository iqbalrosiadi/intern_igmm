...
dataf<-read.table(paste("nullDATA80_5intstrongfullnew.",i, sep=""), header=TRUE)
datar<-read.table(paste("nullDATA80_5intstrongrednew.",i, sep=""), header=TRUE)
...
write.table(nullVIM80_5f, "nullVIM80_5intstrongfullnew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC80_5f, "nullVIMAUC80_5intstrongfullnew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIM80_5r, "nullVIM80_5intstrongrednew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(nullVIMAUC80_5r, "nullVIMAUC80_5intstrongrednew", row.names=FALSE, col.names=TRUE,quote=FALSE)
