...
dataf<-read.table(paste("DATA80_20intweakfullmid.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA80_20intweakredmid.",i, sep=""), header=TRUE)
...
write.table(VIM80_20f, "VIM80_20intweakfullmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC80_20f, "VIMAUC80_20intweakfullmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIM80_20r, "VIM80_20intweakredmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC80_20r, "VIMAUC80_20intweakredmid", row.names=FALSE, col.names=TRUE,quote=FALSE)
