...
write.table(data2, paste("DATA40_20intstrongfullnew.",i, sep=""), row.names=FALSE, quote=FALSE)
write.table(data3, paste("DATA40_20intstrongrednew.",i, sep=""), row.names=FALSE, quote=FALSE)
}
