...
write.table(data2, paste("DATA40_5intstrongfullnew.",i, sep=""), row.names=FALSE, quote=FALSE)
write.table(data3, paste("DATA40_5intstrongrednew.",i, sep=""), row.names=FALSE, quote=FALSE)
}
