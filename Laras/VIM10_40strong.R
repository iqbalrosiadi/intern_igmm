...
dataf<-read.table(paste("DATA10_40intstrongfullnew.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA10_40intstrongrednew.",i, sep=""), header=TRUE)
...
write.table(VIM10_40f, "VIM10_40intstrongfullnew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC10_40f, "VIMAUC10_40intstrongfullnew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIM10_40r, "VIM10_40intstrongrednew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC10_40r, "VIMAUC10_40intstrongrednew", row.names=FALSE, col.names=TRUE,quote=FALSE)
