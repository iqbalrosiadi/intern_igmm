...
dataf<-read.table(paste("DATA40_40intweakfull033.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA40_40intweakred05.",i, sep=""), header=TRUE)
...
write.table(VIM40_40f, "VIM40_40intweakfull033", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC40_40f, "VIMAUC40_40intweakfull033", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIM40_40r, "VIM40_40intweakred05", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC40_40r, "VIMAUC40_40intweakred05", row.names=FALSE, col.names=TRUE,quote=FALSE)
