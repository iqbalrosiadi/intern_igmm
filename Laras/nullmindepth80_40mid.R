...
af<-read.table(paste("nullDATA80_40intweakfullmid.",i,sep=""),header=TRUE)
#[,1]
ar<-read.table(paste("nullDATA80_40intweakredmid.",i,sep=""),header=TRUE)
#[,1]
...
write.table(depth15f,"nullmindepth80_40_39weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp15f,"nullvimp80_40_39weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3f,"nullmindepth80_40_27weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp3f,"nullvimp80_40_27weakfullmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth15r,"nullmindepth80_40_39weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp15r,"nullvimp80_40_39weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(depth3r,"nullmindepth80_40_27weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(nullvimp3r,"nullvimp80_40_27weakredmid",row.names=FALSE,col.names=TRUE,quote=FALSE)
