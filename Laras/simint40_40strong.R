...
write.table(data2, paste("DATA40_40intstrongfullnew.",i, sep=""), row.names=FALSE, quote=FALSE)
write.table(data3, paste("DATA40_40intstrongrednew.",i, sep=""), row.names=FALSE, quote=FALSE)
}
