...
dataf<-read.table(paste("DATA80_40intstrongfullnew.",i, sep=""), header=TRUE)
datar<-read.table(paste("DATA80_40intstrongrednew.",i, sep=""), header=TRUE)
...
write.table(VIM80_40f, "VIM80_40intstrongfullnew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC80_40f, "VIMAUC80_40intstrongfullnew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIM80_40r, "VIM80_40intstrongrednew", row.names=FALSE, col.names=TRUE,quote=FALSE)
write.table(VIMAUC80_40r, "VIMAUC80_40intstrongrednew", row.names=FALSE, col.names=TRUE,quote=FALSE)
